    ...
    */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Results Dashboard";
    			t1 = space();
    			h2 = element("h2");
    			h2.textContent = "Imperial College NHS";
    			t3 = space();
    			h3 = element("h3");
    			h3.textContent = "Burnout Scale Results";
    			t5 = space();
    			div = element("div");
    			t6 = space();
    			p = element("p");
    			em = element("em");
    			em.textContent = "Data for illustrative purposes only";
    			add_location(h1, file, 69, 0, 1525);
    			add_location(h2, file, 70, 0, 1552);
    			add_location(h3, file, 71, 0, 1582);
    			attr_dev(div, "class", "ct-chart ct-perfect-fourth");
    			add_location(div, file, 72, 0, 1613);
    			add_location(em, file, 74, 2, 1680);
    			add_location(p, file, 73, 0, 1674);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		const days = [...Array(14).keys()].map(index => {
    			return luxon_1.local().minus({ days: 1 }).minus({ days: 7 * index });
    		}).reverse();
    		...
    		{
    				plugins: [Chartist.plugins.ctTargetLine({ value: 4 })]
    			});
    	});
